...
public class TestBO {
	public static void main(String[] args) throws InvalidXMLException, ItemAlreadyExistsException, ItemNotFoundException, UserNotFoundException {
		String userXML = "<user><username>srini</username><password>srini</password></user>";		
...
//		System.out.println(UserBO.getJSON("srini"));
  //              System.out.println(UserBO.getJSON("jose2"));
		
		//System.out.println(UserBO.getAllXML());
		//System.out.println(UserBO.getAllJSON());
		
                userXML = "<user><username>srini</username><password>gaya3</password></user>";
                UserBO.update(userXML);
		//UserBO.delete("jose2");
                //UserBO.delete("felix");
		//System.out.println(UserBO.getXML("jose2"));
...
//		System.out.println(MessageBO.getAllJSONForUser("srini"));
//		System.out.println("----------------");
